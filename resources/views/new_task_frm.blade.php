...
<div class="container">
    <div class="row">
        <div class="col">
            <h2><i class="bi bi-plus-lg me-2"></i>New task</h2>
            <hr>
            <form action="{{ route('new_task_submit') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="text_task_name" id="text_task_name" placeholder="Task name" value="{{ old('text_task_name') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="text_task_description" class="form-control" id="text_task_description" cols="30" rows="10" placeholder="Task description">{{ old('text_task_description') }}</textarea>
