        ...
        <div class="col">
            ...
            <form action="{{ route('new_task_submit') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="text_task_description" class="form-control" id="text_task_description" cols="30" rows="10" placeholder="Task description" value="{{ old('text_task_description') }}"></textarea>
